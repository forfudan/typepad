...
define([
   ...
   return {
      ...
      article0: {
         ...
         content: "当你点开这个页面的时候，你就是一名有缘人。从第一次牙牙学语，到知道自己名字的写法，再到于洁白信纸上写下洋洋洒洒的文章。这每一座人生里程碑，都是一次同母语母文的邂逅和牵连。上下五千年，东西九万里，中国历史上，多少人曾穷经皓首、青灯红烛，在不同载体上，写下一个又一个汉字。只在那方寸之间，将灿烂的中华文明，传承了一代又一代。你是否怀念初中时代的书桌前，用几种颜色的中性笔，书写着自己青春的悸动？你是否记得高中时代，你曾以笔为剑，书写着对生活、对国家的思考？你是否想起，曾经一笔一划抄录过唐诗宋词。那些波澜壮阔，抑或是清新隽永的诗句，至今仍让你不时想起而心潮澎湃？如果你怀念这种一笔一划书写的感觉，那么，你来对了地方。宇浩输入法，就是这样一款输入法：它为创作而设计，对汉字怀有一份脉脉温情。不同于拼音输入法需要先输入读音，再选择想要的汉字，宇浩输入法将汉字的部首和笔画，安排在键盘二十六个按键上。当你连续按下一个汉字中若干部首，这个汉字便会跳到屏幕上。在宇浩输入法中，每一个汉字，都基本对应着唯一编码。因此在输入过程中，你并不需要进行「选择汉字」这个操作。就像你在写字的时候，从不会停下来选择汉字。用了它，你在打字中便不会经历恼人的停顿，在无尽的菜单栏中搜索想要的那个汉字；你可以如同在纸上书写一般打字，享受一种「下笔如有神」的自由感和「我书我所想」的掌控度。你甚至可以忽略输入框，享受闭眼创作的乐趣，自由书写古今汉字，在现代文、文言文之间随心徜徉。文字不再是一匹匹无羁的野马，而是你指间缓缓流淌的旋律。「确定带来自由」。如果你心动于这种体验，说明你是一个既浪漫又有品味的人，不妨加入我们吧！"
      },
      article1: {
         name: '致有緣人(傳統字)',
         value: 'article1',
         type: ArticleType.article,
         content: "當你點開這個頁面的時候，你就是一名有緣人。從第一次牙牙學語，到知道自己名字的寫法，再到於潔白信紙上寫下洋洋灑灑的文章。這每一座人生里程碑，都是一次同母語母文的邂逅和牽連。上下五千年，東西九萬里，中國歷史上，多少人曾窮經皓首、青燈紅燭，在不同載體上，寫下一個又一個漢字。只在那方寸之間，將燦爛的中華文明，傳承了一代又一代。你是否懷念初中時代的書桌前，用幾種顏色的中性筆，書寫着自己青春的悸動？你是否記得高中時代，你曾以筆爲劍，書寫着對生活、對國家的思考？你是否想起，曾經一筆一劃抄錄過唐詩宋詞。那些波瀾壯闊，抑或是清新雋永的詩句，至今仍讓你不時想起而心潮澎湃？如果你懷念這種一筆一劃書寫的感覺，那麽，你來對了地方。宇浩輸入法，就是這樣一款輸入法：它爲創作而設計，對漢字懷有一份脉脉溫情。不同於拼音輸入法需要先輸入讀音，再選擇想要的漢字，宇浩輸入法將漢字的部首和筆畫，安排在鍵盤二十六個按鍵上。當你連續按下一個漢字中若干部首，這個漢字便會跳到屏幕上。在宇浩輸入法中，每一個漢字，都基本對應着唯一編碼。因此在輸入過程中，你並不需要進行「選擇漢字」這個操作。就像你在寫字的時候，從不會停下來選擇漢字。用了它，你在打字中便不會經歷惱人的停頓，在無盡的菜單欄中搜索想要的那個漢字；你可以如同在紙上書寫一般打字，享受一種「下筆如有神」的自由感和「我書我所想」的掌控度。你甚至可以忽略輸入框，享受閉眼創作的樂趣，自由書寫古今漢字，在現代文、文言文之間隨心徜徉。文字不再是一匹匹無羈的野馬，而是你指間緩緩流淌的旋律。「確定帶來自由」。如果你心動於這種體驗，説明你是一個既浪漫又有品味的人，不妨加入我們吧！"
      },
      article2: {
         name: '宇浩拆分基礎教程',
         value: 'article2',
         type: ArticleType.article,
         content: "宇浩拆分基礎教程基本信息拆字，就是把漢字按照一定的規則，拆成唯一的、有序的字根組合。這個過程如同拼圖一般，大多數時候，是非常直觀而自然的。這種將字拆成直觀的、分離的部件的方法，足以應付大部分漢字的拆分。例字但在實際使用中，會遇到這樣的問題：一個獨體字，本身不是字根，該怎麽辦？這時候，我們要把它繼續拆成更小的字根甚至筆劃。例字「戋」這個字，我們可以繼續將它拆成「一」和「戈」。查字根圖可知，「一」和「戈」正好是兩個字根，拆字成功。「丸」這個字，我們可以繼續將它拆成「九」和「丶」。查字根圖可知，「九」和「丶」正好是兩個字根，拆字成功。「朱」這個字，我們可以繼續將它拆成「牛」和「八」。查字根圖可知，「牛」和「八」正好是兩個字根，拆字成功。有時候，獨體字的拆分不是很直觀。遇到此類字時的拆分，往往需要一些經驗和練習。而更麻煩的情況是，一個字好像有幾種拆分方法。比如以下這些字例：例字「再」，可以拆「一冂土」，也可以拆「王冂」。「单」可以拆成「丷日十」也可以拆成「丷冂丰」。「主」可以拆成「丶王」也可以拆成「亠土」。這種一個漢字、多種拆法的情況，是漢字的本質所決定的，本質上不是錯誤。但一字多拆，確實帶來了極大的不確定性，會造成編碼的混亂。我們無法避免一字多拆，但能通過制定一套明確的拆字規則，來選出唯一的拆分方案。拆分規則宇浩拆分，就是總結了前輩輸入法的拆字規則，通過大量的努力和自我審視，明確了一套嚴格的優先級系統，使得每一個漢字，都有唯一的拆分方案，消除了不確定性。這套規則，有三個核心目標：直觀性：絶大部分的漢字，能夠被直觀地拆分，符合人們對漢字結構的認知。唯一性：絶大部分的漢字，能夠被唯一地拆分，消除不確定性。簡潔性：拆分規則簡潔明了，避免過多特例，易於理解和記憶。請注意，雖然拆分規則的第一目標是直觀性，但總有部分漢字在部分人群的眼中不夠直觀，這是無法避免的。漢字本身具有多樣性和複雜性，各人的學習經歷也大相徑庭，不可能讓每個字都滿足所有人的口味。因此，規則定下後，就算有部分漢字的拆法不够直觀，我們也不再設置特例去調整它們的拆分方法，也不會加入直觀優先的灰色地帶。這是爲了保證規則的簡潔性和拆分的唯一性。這一點，在面對大字集的時候，顯得尤爲重要。拆字優先級「宇浩」拆字規則，按優先級排序如下：字根最少結構完整符合筆順能散不連能連不交能交不斷保持原形向前取大以上優先級，還可以高度歸納爲：少整順散連交斷原大。取根時，如果有多種不同的拆分方式，則按優先級從高到低依次檢查以上規則，選取符合條件的，排除不滿足的，最終得到唯一的拆分方案。因此，某種意義上來説，宇浩輸入法的拆分規則，其實是一種比較和淘汰的排除法。以下爲拆分規則詳細介紹：字根最少字根最少，意思是拆分一個字時，應該使得拆出的字根數量盡可能地少。保證字根數量最少，是優先級最高的規則。結構完整結構完整，指的是存在半包圍形態的字根和存在全包圍形態的字根不拆散。包括：勹⺆冂匚コ凵囗（日田目）這個原則的設置，是爲了不過分破壞漢字的整體性和直觀性，讓相似形態的字擁有相似的拆分方式。下面幾個例子可以説明這一點。符合筆順注意到，爲了使字根數量較少、或者讓結構完整，某些大於等於兩劃的字根，它的筆順可能會被另一個或多個字根穿插打斷。比如：「固」字如果拆分成「囗古」兩根，則「囗」字根不是一次性寫完的：它的前兩筆和最後的一橫之間穿插寫了一個「古」。這種情況，有些人會覺得更加直觀（全包圍結構），但有時候會讓人感覺不自然（違背了筆順）。這説明我們對於「筆順」這個因素，不能完全忽視。在介紹「符合筆順」這個規則前，我們先引入字根「一體寫就」的概念：當我們嚴格按照筆順書寫一個漢字時，如果某個字根能夠一次性寫完，不被其他字根穿插打斷，則稱這個字根是「一體寫就」的。相對的，如果某個字根在書寫過程中被其他字根穿插打斷，則稱這個字根是「穿插寫就」的。那麼，任何一個漢字的任何一種拆分方式，都不外乎以下三種情況：全部字根一體寫就（又稱整體符合筆順）：指這種拆分方式下，所有的字根都一體寫就，字根之間不會互相干擾穿插。比如，「涸」字若拆成「氵冂古一」，便算作整體符合筆順。部分字根一體寫就（又稱局部符合筆順）：指這種拆分方式下，一部分字根一體寫就，另一部分的字根會穿插寫就。「涸」字若拆成「氵囗古」，便算作局部符合筆順，因爲其中的「囗」不是一體寫就的，而「氵」「古」都是一體寫就的。全部字根穿插寫就（又稱整體不合筆順）：指這種拆分方式下，所有的字根都是穿插寫就的。「州」字若拆成「𭕄川」，便算作整體不合筆順。這種情況很少出現，一般見於兩根字中。「符合筆順」規則便是要求：如果存在兩種不同的拆分方式，則優先選擇一體寫就字根更多的那一種拆分。符合筆順的優先級低於字根最少。散連交斷散·連·交·斷，是漢字部首或筆畫的四種狀態。字根離散，指的是兩個字根互相分離。比如「部」中的「立口阝」，便是三個分離的字根。字根相連，指的是兩個字根互相連接。比如「美」拆爲「𦍌大」，這兩個字根是相連的。字根相交，指的是兩個字根互相交叉。比如「再」拆成「一冂土」三個字根，便是相交的。筆劃斷開，指的是一個筆劃（橫或豎）斷開。比如「我」拆成「丿扌戈」三個字根，其中的「扌」和「戈」兩根的橫本是一筆寫成，但我們將橫畫斷開。「散連交斷」，優先級依次下降，但都排在「字根最少」「結構完整」「符合筆順」之後。能散不連兩個字根互相分離，優於兩個字根互相連接。能連不交兩個字根互相分離，優於兩個字根互相交叉。能交不斷兩個字根互相交叉，優於將筆畫斷開。筆畫斷開爲了根少和直觀，不少輸入法允許將一些筆畫斷開，分屬不同的字根中。宇浩拆分中，有且只有以下兩種情況可以斷開筆畫：「我識羲」等字中「戈」的橫，可以向左斷開。「重熏」等字中「千」的竪，可以向下斷開。在本教程中，被斷開的筆畫使用灰白色標識，以示區别。因爲筆畫被斷開並歸入兩個字根，因此這一筆的筆順被兩個字根共享。比如：「戠」應當拆成「立戈日」，而不是「立日戈」，因爲被斷開的橫畫同時屬於「立」字根和「戈」字根，橫畫的筆順早於「日」字根，故而「戈」應當排在「日」之前。這樣的規定，一方面保證了客觀筆順的正確性，另一方面也保證了相似結構的字擁有相似的拆分方式。比如：「栽」拆作「十戈木」、「武」拆作「一戈止」、「戠」拆作「立戈日」，不管斷筆還是不斷筆，都保證「戈」的位置一致。保持原形部分字根在做偏旁的時候，由於書法的考慮，會有略微的變形處理，將「丨」寫作「丿」。爲了拆分直觀，我們不能濫用這些變形字根。「保持原形」規則，便是要求此類變形字根數量盡可能少。向前取大向前取大，指的是讓首筆靠前的字根的筆劃數儘可能地多。這是一個兜底原則，可以保證最終只有一個候選方案能夠勝出。它的優先級是所有拆字規則中最低的。"
      },
      article3: {
         name: '春 - 朱自清',
         value: 'article3',
